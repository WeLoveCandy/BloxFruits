                ...
                if Input.KeyCode == window.key then
                    if cooldown == false then
                        if toggled then
                            ...
                            if window.y then
                                if
                                    (outline.AbsolutePosition.Y + (outline.AbsoluteSize.Y / 2)) <
...
local window =
    library:new({textsize = 13.5, font = Enum.Font.RobotoMono, name = "Krahub", color = Color3.fromRGB(224, 67, 67)})
...
local Main = Main:section({name = "General", side = "left", size = 1000})
local Main = Main:section({name = "Stats", side = "right", size = 250})

local Items = Items:section({name = "General", side = "left", size = 250})
local Items = Items:section({name = "Island", side = "left", size = 250})
Main:toggle(
    {
        name = "Toggle",
        def = false,
