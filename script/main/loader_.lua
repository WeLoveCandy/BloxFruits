...
local window =
    library:new(
    {textsize = 13.5, font = Enum.Font.RobotoMono, name = "Krahub | Blox fruits", color = Color3.fromRGB(224, 67, 67)}
)
...
local MainR = Main:section({name = "Stats/Settings", side = "right", size = 450})
